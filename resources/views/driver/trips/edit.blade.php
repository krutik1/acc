            ...
            <div class="card-body">
                @if($trip->status === 'approved')
                    <div class="alert alert-danger mb-4">
                        ...
                        This trip has already been approved and can no longer be edited. Please contact the administrator if changes are required.
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('driver.trips.update', $trip) }}">
                    ...
                    <fieldset {{ $trip->status === 'approved' ? 'disabled' : '' }}>
                        <!-- Trip Date -->
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            @else
                                <button type="button" class="btn btn-secondary" disabled>
                                    <i class="bi bi-lock-fill me-1"></i>Approved (Read-Only)
                                </button>
                            @endif
                        </div>
                    </fieldset>
