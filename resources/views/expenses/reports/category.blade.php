...
@section('title', 'Category-wise Expenses')

@section('content')
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 text-gray-800">Category-wise Expenses</h1>
    <a href="{{ route('expenses.reports.export', ['type' => 'category', 'from_date' => $fromDate, 'to_date' => $toDate]) }}" class="btn btn-success">
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('expenses.reports.category-wise') }}" class="row g-3 align-items-end">
            <div class="col-md-3">
