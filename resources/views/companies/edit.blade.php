            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    @if($company->logo_path)
                        <div class="mb-2">
                            <img src="{{ Storage::url($company->logo_path) }}" alt="Logo" class="img-thumbnail" style="max-height: 80px;">
                        </div>
                    @endif
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @if($company->favicon_path)
                        <div class="mb-2">
                            <img src="{{ Storage::url($company->favicon_path) }}" alt="Favicon" class="img-thumbnail" style="max-height: 32px;">
                        </div>
                    @endif
